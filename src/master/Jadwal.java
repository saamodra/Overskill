...
public class Jadwal extends javax.swing.JFrame {
    ...
    private void addColumn() {
        ...
        String colTitles[] = {"ID Jadwal", "Deskripsi", "ID Kelas", "Nama Kelas", "Tanggal", "Jam Awal", "Jam Akhir", "Status Jadwal"};
    ...
    private void loadData(String cari) {
        try {
            ...
            while(c.result.next()) {
                ...
                obj[1] = r.getString("Deskripsi_Jadwal");
                obj[2] = r.getString("ID_Kelas");
                obj[3] = r.getString("Nama_Kelas");
                obj[4] = sdd.format(r.getDate("Tanggal"));
                obj[5] = sdf.format(r.getTime("Jam_Awal"));
                obj[6] = sdf.format(r.getTime("Jam_Akhir"));
                obj[7] = (r.getInt("Status") == '0' ? "Selesai" : "Sedang Berjalan");
