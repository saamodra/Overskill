...
public class Siswa extends javax.swing.JFrame {
    ...
    private void addColumn() {
        ...
        String colTitles[] = {"ID Siswa", "Nama Siswa", "Tanggal Lahir", "Jenis Kelamin", "Alamat", 
            "No. Telp", "Email", "No. Telp Orang Tua", "Status Siswa" , "Username"};
    ...
    private void loadData(String cari) {
        try {
            ...
            while(c.result.next()) {
                ...
                obj[7] = r.getString("Notelp_ortu");
                obj[8] = r.getString("Status_Siswa");
    ...
    private void tblMasterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMasterMouseClicked
        ...
        data[9] = (String) model.getValueAt(i, 9);
