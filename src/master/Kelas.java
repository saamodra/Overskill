...
public class Kelas extends javax.swing.JFrame {
    ...
    private void addColumn() {
        ...
        String colTitles[] = {"ID Kelas", "Nama Kelas", "ID Instruktur", "Nama Instruktur", "Pertemuan", "Harga", "Status Kelas"};
    ...
    private void loadData(String cari) {
        try {
            ...
            String sql = "SELECT * FROM Kelas k JOIN Instruktur i ON k.ID_Instruktur = i.ID_Instruktur WHERE k.Status='1' ORDER BY k.ID_Kelas";
            ...
            while(c.result.next()) {
                ...
                obj[0] = r.getString("ID_Kelas");
                obj[1] = r.getString("Nama_Kelas");
                obj[2] = r.getString("ID_Instruktur");
                obj[3] = r.getString("Nama_Instruktur");
                obj[4] = r.getString("Pertemuan");
                obj[5] = formatter.format(r.getDouble("Harga"));
                obj[6] = (r.getInt("Status_Kelas") == '0' ? "Selesai" : "Sedang Berjalan");
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        JDialog d = new JDialog(this , "Tambah Kelas", true);  
        d.setLayout( new FlowLayout() );  
        FormKelas kel = new FormKelas(d);
        d.add(kel.getPanel());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        if(!data[0].equals("")) {
            int result = OSLib.deleteData("Kelas", "ID_Kelas", data[0]);
            
            if(result == 1) {
                JOptionPane.showMessageDialog(this, "Data Kelas berhasil dihapus.", "Berhasil",  JOptionPane.INFORMATION_MESSAGE);
                formLoad();
            } else {
                JOptionPane.showMessageDialog(this, "Data Kelas gagal dihapus.", "Gagal",  JOptionPane.INFORMATION_MESSAGE);
            }
        } else {
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        ...
        {
            JDialog d = new JDialog(this , "Ubah Kelas", true);  
            d.setLayout( new FlowLayout() );  
            FormKelas t = new FormKelas(d, data);
    ...
    private void tblMasterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMasterMouseClicked
        ...
        data[3] = (String) model.getValueAt(i, 3);
        data[4] = (String) model.getValueAt(i, 4);
        data[5] = (String) model.getValueAt(i, 5);
        data[6] = (String) model.getValueAt(i, 6);
