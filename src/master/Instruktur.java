...
public class Instruktur extends javax.swing.JFrame {
    ...
    private void addColumn() {
        ...
        String colTitles[] = {"ID Instruktur", "Nama Instruktur", "Tanggal Lahir", "Jenis Kelamin", "Alamat", "No. Telp", "Email", "Pengalaman Kerja", "Username", "Role"};
    ...
    private void loadData(String cari) {
        try 
        {
            ...
            while(c.result.next()) {
                ...
                obj[0] = r.getString("ID_Instruktur");
                obj[1] = r.getString("Nama_Instruktur");
                obj[2] = r.getString("Tanggal_lahir");
                obj[3] = r.getString("Jenis_Kelamin");
                obj[4] = r.getString("Alamat");
                obj[5] = r.getString("No_telp");
                obj[6] = r.getString("Email");
                obj[7] = r.getString("Pengalaman_kerja");
                obj[8] = r.getString("Username");
                obj[9] = r.getString("Password");
                model.addRow(obj);
            }
            c.stat.close();
            c.result.close();
    ...
    private void initComponents() {
        ...
        btnUbah.setText("EDIT INSTRUKTUR");
    ...
    private void tblMasterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMasterMouseClicked
        ...
        data[7] = (String) model.getValueAt(i, 7);
        data[8] = (String) model.getValueAt(i, 8);
