...
public class DashboardInstruktur extends javax.swing.JFrame {
    ...
    private void getAllData() {
        try {
            ...
            // sql query
            String sql = "SELECT COUNT(*) as jumlah FROM Kelas WHERE ID_Instruktur = '" + OSSession.getId() + "' AND Status='1'";
            ...
            sql = "SELECT COUNT(*) as jumlah FROM Jadwal j JOIN Kelas k ON j.ID_Kelas = k.ID_Kelas "
                    + "WHERE k.ID_Instruktur = '" + OSSession.getId() + "' AND j.Status='1'";
            c.result = c.stat.executeQuery(sql);
            while(c.result.next()) {
                ResultSet r = c.result;
            ...
            sql = "SELECT COUNT(*) as jumlah FROM Quiz q JOIN Kelas k ON q.ID_Kelas = k.ID_Kelas "
                    + "WHERE k.ID_Instruktur = '" + OSSession.getId() + "' AND q.Status='1'";
            c.result = c.stat.executeQuery(sql);
            while(c.result.next()) {
                ResultSet r = c.result;
            ...
            sql = "SELECT COUNT(*) as jumlah FROM Feedback f JOIN Kelas k ON f.ID_Kelas = k.ID_Kelas "
                    + "WHERE k.ID_Instruktur = '" + OSSession.getId() + "' AND f.Status = '1'";
            c.result = c.stat.executeQuery(sql);
            while(c.result.next()) {
                ResultSet r = c.result;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Quiz yang perlu dikoreksi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardInstruktur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashboardInstruktur().setVisible(true);
            }
        });
    }
