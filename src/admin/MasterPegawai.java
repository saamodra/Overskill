...
public class MasterPegawai extends javax.swing.JFrame {
    ...
    public MasterPegawai() {
        initComponents();
        formLoad();
        JScrollPane scrollPane = new JScrollPane(tblMaster);
        jPanel4.add(scrollPane);
        
        // add table mouseClick Event
    ...
    private void addColumn() {
        String colTitles[] = {"No.", "ID Pegawai", "Nama Pegawai", "Jenis Kelamin", "Alamat", "No. Telp", "Email", "Username", "Role"};
