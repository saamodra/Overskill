...
public class Kelas extends javax.swing.JFrame {
    ...
    private void addColumn() {
        ...
        String colTitles[] = {"No.","ID Kelas", "Nama Kelas", "ID Instruktur", "Nama Instruktur", "Pertemuan", "Harga", "Status Kelas"};
    ...
    private void loadData(String cari) {
        try {
            ...
            while(c.result.next()) {
                ...
                obj[0] = no++;
                obj[1] = r.getString("ID_Kelas");
                obj[2] = r.getString("Nama_Kelas");
                obj[3] = r.getString("ID_Instruktur");
                obj[4] = r.getString("Nama_Instruktur");
                obj[5] = r.getString("Pertemuan");
                obj[6] = formatter.format(r.getDouble("Harga"));
                obj[7] = (r.getInt("Status_Kelas") == '0' ? "Selesai" : "Sedang Berjalan");
