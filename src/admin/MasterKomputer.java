...
public class MasterKomputer extends javax.swing.JFrame {
    ...
    private void addColumn() {
        ...
        String colTitles[] = {"No.","ID Komputer", "Spesifikasi", "Keterangan"};
    ...
    private void loadData(String cari) {
        try {
            ...
            while(c.result.next()) {
                ...
                obj[0] = no++;
                obj[1] = r.getString("ID_Komputer");
                obj[2] = r.getString("Spesifikasi");
                obj[3] = r.getString("Keterangan");
